                            ...
                            <div class="product-wrapper row cols-xl-5 cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                        ...
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/shop/19-1.jpg" alt="Product" width="300"
                                                     height="338" />
                                                <img src="assets/images/shop/19-2.jpg" alt="Product" width="300"
                                                     height="338" />
                                            </a>
                                            <div class="product-action-horizontal">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap">
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/shop/18.jpg" alt="Product" width="300"
                                                     height="338" />
                                            </a>
                                            <div class="product-action-horizontal">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-name">
                                                <a href="product-default.html">CT Marchine</a>
                                            </h3>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 60%;"></span>
