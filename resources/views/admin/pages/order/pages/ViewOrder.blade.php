...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-3">Vendor Information</h4>

                    <ul class="list-unstyled mb-0">
                        @foreach($order as $row)
                            <li>Name:  {{$row->vendor->users->name}}</li>
                            <li>Shop Name: {{$row->vendor->shop_name}} </li>
                            <li>Shop Phone: {{$row->vendor->shop_phone}}</li>
                            <li>Shop Email: {{$row->vendor->shop_email}}</li>
                        @endforeach
                    </ul>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @foreach($order as $row)
                        ...
                        <form action="{{route('InAdmin.Order.Status', $row->id)}}" method="POST">
                            @csrf
                            <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('InAdmin.Order.Add.Courier', $row->id)}}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                    ...
                    @foreach($order as $row)
                        <form action="{{route('InAdmin.Order.Delivery.Status', $row->id)}}" method="POST">
                            @csrf
                            <div class="mb-3">
